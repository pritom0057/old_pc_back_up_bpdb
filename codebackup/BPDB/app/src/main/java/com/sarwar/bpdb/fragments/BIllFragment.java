    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        get_bill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(location_code.getText().toString().length()<=0){
...
//                yearMonth.setText(dateFormat.format(calendar.getTime()));
    ...
    public void getBillInfo(){
        ...
        String url = Constants.BASE_URL+
                "/Service1.svc/GetBill?LocationCode="+location_code.getText().toString()+
                "&ConsumerNumber="+consumer_number.getText().toString()+"&BillMonth="+bill_month.getText().toString();
        prog.show();
...
//                            bill_details.setText(response);
                            ...
                            List<Identify> myModelList = gson.fromJson(response, listType);

                            customer_name.setText(myModelList.get(0).getCUSTOMERNAME());
                            customer_number.setText(myModelList.get(0).getCUSTOMERNUM());
                            ...
                            adapter = new MyRecyclerViewAdapter(getActivity(), myModelList,true);
